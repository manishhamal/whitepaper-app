    ...
    <div className="max-w-4xl mx-auto pb-12">
      ...
      <FadeIn>
        <section className="py-12 md:py-20 mb-8 border-b border-slate-100 dark:border-slate-800">
          ...
          <div className="pt-8">
            <Link to="/articles" className="inline-flex items-center text-sm font-bold uppercase tracking-widest text-slate-900 dark:text-white hover:text-slate-500 transition-colors">
              {t('hero.cta')} →
            </Link>
          </div>
        </section>
      ...
      <section className="relative">
        <FadeIn delay={300}>
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-xs font-bold uppercase tracking-widest text-slate-500 pl-10">{t('home.featuredTitle')}</h2>
